    ...
    <div className="space-y-12 max-w-4xl mx-auto">
      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-8 space-y-6">
        <textarea 
          ...
          className="w-full bg-white border border-slate-200 rounded-lg p-4 text-slate-900 font-mono h-32 focus:outline-none focus:border-blue-500"
          placeholder="Enter LaTeX equation..."
        />
        
        <div className="p-8 bg-white rounded-xl border border-slate-200 min-h-[150px] flex items-center justify-center overflow-x-auto text-2xl">
